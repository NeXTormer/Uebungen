...
/**
 * <b>Einfaches Beispiel fuer ein JDBC-Programm</b></p>
 *
 * <p>Im Beispiel wird eine Verbindung zur Test-Datenbank aufgebaut.
 *    Eine Tabelle wird erzeugt und mit Werten beschrieben. Diese Werte
 *    werden anschlieszend wieder ausgelesen, die Tabelle wird geloescht.</p>
 *
 * <p>Bevor das Programm gestartet werden kann, muss der MySql-Server
 *    gestartet werden.</p>
 *
 */
